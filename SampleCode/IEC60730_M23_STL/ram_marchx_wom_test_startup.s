...
;                                                                                                             *
; @file     ram_marchx_wom_test_startup.s                                                                     *
; @version  V1.00                                                                                             *
; $Date: 3/10/21 4:12p $                                                                                     *                                                       *
; @note                                                                                                       *
...
;                  R2 .. Background pattern - '0'
; Local          : R3 .. Inverted background pattern - '0xFFFFFFFF'
...
IEC60730_FullRamMarchX_WOM
	...
	LDR  	R2, =g_u32RAMStartAddr
	LDR		R3, =g_u32RAMEndAddr
	LDR   	R0, [R2,#+0]	
	LDR   	R1, [R3,#+0]
	LDR  	R2, =0x00
...
__FULL_WOM_2_LOOP
	...
	LDR   	R6, [R5,#+0]
	CMP   	R6, R2          ;For SW test breakpoint
	BNE   	__FULL_WOM_ERR
	STR   	R3, [R5,#+0]
	LDR   	R6, [R5,#+4]
	CMP   	R6, R2
