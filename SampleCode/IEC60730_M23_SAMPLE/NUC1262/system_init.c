...
void SYS_Init(void)
{
    ...
    CLK_SetModuleClock(WWDT_MODULE, CLK_CLKSEL2_WWDTSEL_LIRC, 0);
    ...
    /* Select EADC module clock source as PCLK1 and EADC module clock divider as 48 */
    CLK_SetModuleClock(ADC_MODULE, CLK_CLKSEL1_ADCSEL_HIRC_DIV2, CLK_CLKDIV0_ADC(12));
